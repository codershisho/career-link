    ...
    <v-form v-model="valid">
      ...
      <div class="d-flex align-center py-4">
        ...
        <v-switch
          ...
          inset
          color="accent"
          :label="store.phaseResults[store.selectedPhaseId - 1].result_flg ? `通過` : `不合格`"
          :true-value="1"
          :false-value="0"
      ...
      <div class="d-flex align-center py-4">
        ...
        <o-area placeholder="総評" v-model="store.phaseResults[store.selectedPhaseId - 1].review_comment"> </o-area>
      </div>
      <div class="d-flex align-center py-4">
        <div class="text-textmain w-30">メモ・備考</div>
        <o-area placeholder="メモ・備考" v-model="store.phaseResults[store.selectedPhaseId - 1].memo"> </o-area>
      </div>
      <v-divider></v-divider>
