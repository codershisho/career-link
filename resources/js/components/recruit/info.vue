  ...
  <v-card flat class="pa-4" v-if="store.recruit">
    <div class="info-row">
      <div class="mr-2">
        ...
        <o-text variant="outlined" v-model="store.recruit.name"></o-text>
      </div>
      <div>
        <div class="text-textmain pb-2">name kana:</div>
        <o-text variant="outlined" v-model="store.recruit.name_kana"></o-text>
      </div>
    </div>
    <div class="info-row">
      <div class="d-flex w-50 mr-2">
        <div class="mr-2 w-50">
          ...
          <o-text
            variant="outlined"
            v-model="store.recruit.birth_date"
          ></o-text>
        </div>
        <div class="w-50">
          <div class="text-textmain pb-2">join date:</div>
          <o-text variant="outlined" v-model="store.recruit.join_date"></o-text>
        </div>
      </div>
      <div>
        <div class="text-textmain pb-2">email:</div>
        <o-text variant="outlined" v-model="store.recruit.email"></o-text>
      </div>
    </div>
    <div class="info-row">
      <div class="d-flex mr-2 w-50">
        <div class="mr-2 w-50">
          ...
          <o-text variant="outlined" v-model="store.recruit.phone"></o-text>
        </div>
        <div class="w-50">
          <div class="text-textmain pb-2">post code:</div>
          <o-text variant="outlined" v-model="store.recruit.post_code"></o-text>
        </div>
      </div>
      <div>
        <div class="text-textmain pb-2">address:</div>
        <o-text variant="outlined" v-model="store.recruit.address"></o-text>
      </div>
    </div>
    <div class="mt-2">
